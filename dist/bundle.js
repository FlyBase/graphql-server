  ...
  Query: {
    allelesByGene: function () {
      ...
      regeneratorRuntime.mark(function _callee(_, _ref, ___, ____) {
        var fbgn, _ref$isConstruct, isConstruct, result;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                fbgn = _ref.fbgn, _ref$isConstruct = _ref.isConstruct, isConstruct = _ref$isConstruct === void 0 ? false : _ref$isConstruct;
                _context.next = 3;
